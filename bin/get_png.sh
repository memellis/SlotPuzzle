#!/bin/bash
#
# Build Portable Network Graphics library (libpng) for MinGW
#

SOURCE_URL=http://sourceforge.net/projects/libpng/files/libpng16/1.6.5/libpng-1.6.5.tar.gz/download
SOURCE_ARCHIVE=libpng-1.6.5.tar.gz
