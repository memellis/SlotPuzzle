#!/bin/bash
#
# Build yasm for mingw
#

SOURCE_URL=http://sourceforge.net/projects/pkgconfiglite/files/0.28-1/pkg-config-lite-0.28-1.tar.gz/download
SOURCE_ARCHIVE=pkg-config-lite-0.28-1.tar.gz
