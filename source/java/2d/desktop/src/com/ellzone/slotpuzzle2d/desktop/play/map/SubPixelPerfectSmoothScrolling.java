...
public class SubPixelPerfectSmoothScrolling implements ApplicationListener {
	...
	private static final int FRAMEBUFFER_HEIGHT = 240;
	...
	private static final float CAMERA_BORDER_DIST_X = 0.5f * CAMERA_WIDTH;
	private static final float CAMERA_BORDER_DIST_Y = 0.5f * CAMERA_HEIGHT;

	private static final float WORLD_UNIT_SCALE = 40.0f;
	...
	public void create() {
		...
		tiledMap = new TmxMapLoader().load("levels/WorldMap.tmx");
	...
	private class Input extends InputAdapter {
		...
		public boolean keyDown(int keycode) {
			switch (keycode) {
				case Keys.A:
					...
					SubPixelPerfectSmoothScrolling.this.cameraDirection.x = -1.0f;
					return true;
				case Keys.D:
					SubPixelPerfectSmoothScrolling.this.cameraDirection.x = 1.0f;
					return true;
				case Keys.W:
					SubPixelPerfectSmoothScrolling.this.cameraDirection.y = 1.0f;
					return true;
				case Keys.S:
					SubPixelPerfectSmoothScrolling.this.cameraDirection.y = -1.0f;
					return true;
		...
		public boolean keyUp(int keycode) {
			switch (keycode) {
				case Keys.A:
					SubPixelPerfectSmoothScrolling.this.cameraDirection.x = 0.0f;
					return true;
				case Keys.D:
					SubPixelPerfectSmoothScrolling.this.cameraDirection.x = 0.0f;
					return true;
				case Keys.W:
					SubPixelPerfectSmoothScrolling.this.cameraDirection.y = 0.0f;
					return true;
				case Keys.S:
					SubPixelPerfectSmoothScrolling.this.cameraDirection.y = 0.0f;
					return true;
