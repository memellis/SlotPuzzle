...
import com.ellzone.SPPrototypes.*;
import java.nio.channels.*;

public class Mellow implements Screen {
	...
	public Mellow(SPPrototypes game) {
		this.game = game;
		create();
	}
	...
	private class Input extends InputAdapter {
		...
		public boolean keyDown(int keycode) {
			switch (keycode) {
				case Keys.A:
					Mellow.this.cameraDirection.x = -1.0f;
					return true;
				case Keys.D:
					Mellow.this.cameraDirection.x = 1.0f;
					return true;
				case Keys.W:
					Mellow.this.cameraDirection.y = 1.0f;
					return true;
				case Keys.S:
					Mellow.this.cameraDirection.y = -1.0f;
					return true;
		...
		@Override
			public boolean keyUp(int keycode) {
				switch (keycode) {
					case Keys.A:
						Mellow.this.cameraDirection.x = 0.0f;
						return true;
					case Keys.D:
						Mellow.this.cameraDirection.x = 0.0f;
						return true;
					case Keys.W:
						Mellow.this.cameraDirection.y = 0.0f;
						return true;
					case Keys.S:
						Mellow.this.cameraDirection.y = 0.0f;
						return true;
