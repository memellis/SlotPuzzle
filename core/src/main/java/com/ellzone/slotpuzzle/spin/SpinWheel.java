 ...
 * <li><a>
 * href="<a href="https://gamedev.stackexchange.com/questions/72170/how-simulate-the-return-effect-of-the-wheel-of-fortune-needle">...</a>">
...
public class SpinWheel implements Disposable {
    ...
    private void pegs_of_wheel() {
        ...
        for (int i = 0; i < nPegs; i++) {
            double theta = Math.toRadians(((double) 360 / nPegs) * i);
