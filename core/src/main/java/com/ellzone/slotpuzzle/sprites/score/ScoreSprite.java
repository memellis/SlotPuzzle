...
package com.ellzone.slotpuzzle.sprites.score;

import com.badlogic.gdx.graphics.Color;
import com.badlogic.gdx.graphics.g2d.BitmapFont;
import com.badlogic.gdx.graphics.g2d.SpriteBatch;
import com.ellzone.slotpuzzle.effects.Particle;

public class ScoreSprite extends Particle {
    private BitmapFont scoreFont;
    private Color fontColor;
    private int score;

    public ScoreSprite(float x, float y, int score) {
        super.setX(x);
        super.setY(y);
        this.score = score;
