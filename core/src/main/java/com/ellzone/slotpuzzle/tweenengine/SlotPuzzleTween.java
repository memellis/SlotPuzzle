package com.ellzone.slotpuzzle.tweenengine;
 ...
 */
public final class SlotPuzzleTween extends BaseTween<SlotPuzzleTween> {
    // -------------------------------------------------------------------------
    // Static -- misc
    // -------------------------------------------------------------------------
    ...
    public static void setCombinedAttributesLimit(int limit) {
        SlotPuzzleTween.combinedAttrsLimit = limit;
    }
    ...
    public static void setWaypointsLimit(int limit) {
        SlotPuzzleTween.waypointsLimit = limit;
    }
    ...
    private static final Pool.Callback<SlotPuzzleTween> poolCallback = new Pool.Callback<SlotPuzzleTween>() {
        @Override public void onPool(SlotPuzzleTween obj) {obj.reset();}
        @Override public void onUnPool(SlotPuzzleTween obj) {obj.reset();}
    };

    private static final Pool<SlotPuzzleTween> pool = new Pool<SlotPuzzleTween>(20, poolCallback) {
        @Override protected SlotPuzzleTween create() {return new SlotPuzzleTween();}
    };
     ...
     */
    public static SlotPuzzleTween to(Object target, int tweenType, float duration) {
        SlotPuzzleTween tween = pool.get();
     ...
     * @return The generated Tween.
     */
    public static SlotPuzzleTween from(Object target, int tweenType, float duration) {
        SlotPuzzleTween tween = pool.get();
        tween.setup(target, tweenType, duration);
        tween.ease(Quad.INOUT);
        tween.path(TweenPaths.catmullRom);
     ...
     * @return The generated Tween.
     */
    public static SlotPuzzleTween set(Object target, int tweenType) {
        SlotPuzzleTween tween = pool.get();
     ...
     * @see TweenCallback
     */
    public static SlotPuzzleTween call(TweenCallback callback) {
        SlotPuzzleTween tween = pool.get();
     ...
     * @see Timeline
     */
    public static SlotPuzzleTween mark() {
        SlotPuzzleTween tween = pool.get();
        tween.setup(null, -1, 0);
        return tween;
    }
     ...
     * see TweenEquations
     */
    public SlotPuzzleTween ease(TweenEquation easeEquation) {
     ...
     * @return The current tween, for chaining instructions.
     */
    public SlotPuzzleTween cast(Class<?> targetClass) {
     ...
     * @return The current tween, for chaining instructions.
     */
    public SlotPuzzleTween target(float targetValue) {
     ...
     * @return The current tween, for chaining instructions.
     */
    public SlotPuzzleTween target(float targetValue1, float targetValue2) {
     ...
     * @return The current tween, for chaining instructions.
     */
    public SlotPuzzleTween target(float targetValue1, float targetValue2, float targetValue3) {
        targetValues[0] = targetValue1;
        targetValues[1] = targetValue2;
     ...
     * @return The current tween, for chaining instructions.
     */
    public SlotPuzzleTween target(float... targetValues) {
     ...
     * @return The current tween, for chaining instructions.
     */
    public SlotPuzzleTween targetRelative(float targetValue) {
        isRelative = true;
     ...
     * @return The current tween, for chaining instructions.
     */
    public SlotPuzzleTween targetRelative(float targetValue1, float targetValue2) {
        isRelative = true;
     ...
     * @return The current tween, for chaining instructions.
     */
    public SlotPuzzleTween targetRelative(float targetValue1, float targetValue2, float targetValue3) {
        isRelative = true;
        targetValues[0] = isInitialized() ? targetValue1 + startValues[0] : targetValue1;
        targetValues[1] = isInitialized() ? targetValue2 + startValues[1] : targetValue2;
     ...
     * @return The current tween, for chaining instructions.
     */
    public SlotPuzzleTween targetRelative(float... targetValues) {
        if (targetValues.length > combinedAttrsLimit) throwCombinedAttrsLimitReached();
     ...
     * @return The current tween, for chaining instructions.
     */
    public SlotPuzzleTween waypoint(float targetValue) {
     ...
     * @return The current tween, for chaining instructions.
     */
    public SlotPuzzleTween waypoint(float targetValue1, float targetValue2) {
        if (waypointsCnt == waypointsLimit) throwWaypointsLimitReached();
     ...
     * @return The current tween, for chaining instructions.
     */
    public SlotPuzzleTween waypoint(float targetValue1, float targetValue2, float targetValue3) {
        if (waypointsCnt == waypointsLimit) throwWaypointsLimitReached();
     ...
     * @return The current tween, for chaining instructions.
     */
    public SlotPuzzleTween waypoint(float... targetValues) {
        if (waypointsCnt == waypointsLimit) throwWaypointsLimitReached();
     ...
     * @see TweenPaths
     */
    public SlotPuzzleTween path(TweenPath path) {
        this.path = path;
        return this;
    }

    public SlotPuzzleTween setDuration(float duration) {
        this.duration = duration;
        return this;
    }
